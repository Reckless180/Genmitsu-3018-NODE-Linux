...
var Parser = function(){
  ...
  var onGrblEcho = function(d) { // sample string: [echo: G1X25.64136Y9.27651Z-0.08983F24.0]
    let match = d.match(/\[echo: (.+)\]/);
    that.dispatchEvent('grbl-echo', match[1]);
  };
